...
from Informer2020.models.decoder import Decoder, DecoderLayer
...
class Informer(nn.Module):
    def __init__(self, enc_in, dec_in, c_out, seq_len, label_len, out_len, 
        ...
        #加入RaIN
        self.RevIN = RaIN(num_features=d_model)
        ...
        self.norm = RaIN(d_model)
        
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, 
                enc_self_mask=None, dec_self_mask=None, dec_enc_mask=None):
        #norm
        x_enc = self.norm(x_enc, mode='norm')
        ...
        #denorm
        dec_out = self.norm(dec_out, mode='denorm')
